...
public class AddCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bar = findViewById(R.id.toolbar_lect_data);

        setSupportActionBar(bar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        input_subject = findViewById(R.id.text_name_lecturer);
        ...
        ArrayAdapter<CharSequence> adapterday = ArrayAdapter.createFromResource(AddCourseActivity.this,
        ...
        ArrayAdapter<CharSequence> adapterstart = ArrayAdapter.createFromResource(AddCourseActivity.this,
